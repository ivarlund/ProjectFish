...
namespace ProjectFish.Controllers
{
    public class PlacesController : Controller
    {
        ...
        public PlacesController(ProjectFishContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var place = await _context.Place
                .FirstOrDefaultAsync(m => m.Coordinates == id);
            if (place == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(string id, [Bind("Coordinates")] Place place)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PlaceExists(place.Coordinates))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Place.Any(e => e.Coordinates == id);
        }
    }
}
